...
from pyMHMuser.dB.asstcmd_db import add_cmd, cmd_reply, list_cmds, rem_cmd
...
from . import asst, get_string, mediainfo, udB, MHMup_cmd


@MHMup_cmd(pattern="addcmd( (.*)|$)")
async def ac(e):
