...
from pyMHMuser.functions.tools import saavn_search
from telethon.tl.types import DocumentAttributeAudio

from . import async_searcher, con, eod, fast_download, get_string, MHMup_cmd
