...
from pyMHMuser.dB.echo_db import add_echo, check_echo, list_echo, rem_echo
from telethon.utils import get_display_name

from . import LOGS, events, MHMup_bot, MHMup_cmd


@MHMup_cmd(pattern="addecho( (.*)|$)")
async def echo(e):
