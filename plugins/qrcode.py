...
from . import get_string, MHMup_bot, MHMup_cmd


@MHMup_cmd(pattern="qrcode( (.*)|$)")
async def cd(e):
    ...
    pfp = await e.client.get_profile_photos(MHMup_bot.uid)
    img = "resources/extras/MHMuser.jpg"
    if len(pfp) >= 1:
