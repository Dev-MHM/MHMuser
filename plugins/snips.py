...
from pyMHMuser._misc import sudoers
from pyMHMuser.dB.snips_db import add_snip, get_snips, list_snip, rem_snip
from pyMHMuser.functions.tools import create_tl_btn, format_btn, get_msg_button
from telegraph import upload_file as uf
from telethon.utils import pack_bot_file_id

from . import events, get_string, mediainfo, udB, MHMup_bot, MHMup_cmd
from ._inline import something


@MHMup_cmd(pattern="addsnip( (.*)|$)")
async def an(e):
    ...
    MHMup_bot.add_handler(add_snips, events.NewMessage())


@MHMup_cmd(pattern="remsnip( (.*)|$)")
async def rs(e):
    wrd = (e.pattern_match.group(1).strip()).lower()
    if not wrd:
    ...
    for z in xx:
        ...
        if k:
            ...
            if rep:
                ...
                await MHMup_bot.send_message(e.chat_id, msg, file=media)
