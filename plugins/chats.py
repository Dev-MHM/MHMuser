...
from . import HNDLR, LOGS, asst, con, get_string, mediainfo, os, types, udB, MHMup_cmd
...
@MHMup_cmd(pattern="unbanall$", manager=True, admins_only=True, require="ban_users")
async def _(event):
