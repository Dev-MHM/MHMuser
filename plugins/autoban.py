...
from pyMHMuser.dB import autoban_db, dnd_db
from pyMHMuser.functions.admins import get_update_linked_chat
from telethon import events
from telethon.tl.types import Channel

from . import LOGS, asst, get_string, inline_mention, MHMup_bot, MHMup_cmd
...
@MHMup_cmd(pattern="cban$", admins_only=True)
...
@MHMup_cmd(pattern="(list|add|rem)wl( (.*)|$)")
...
if dnd_db.get_dnd_chats():
    MHMup_bot.add_handler(dnd_func, events.ChatAction(func=lambda x: x.user_joined))
