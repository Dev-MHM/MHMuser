...
"""
from pyMHMuser.dB.mute_db import is_muted, mute, unmute
from pyMHMuser.functions.admins import ban_time
from telethon import events
from telethon.utils import get_display_name

from . import asst, eod, get_string, inline_mention, MHMup_bot, MHMup_cmd
...
async def startmute(event):
    ...
    if input_:
        ...
        if reply.out or userid in [MHMup_bot.me.id, asst.me.id]:
