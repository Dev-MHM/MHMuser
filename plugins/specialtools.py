...
from pyMHMuser.functions.google_image import googleimagesdownload
...
@MHMup_cmd(pattern="q( (.*)|$)", manager=True, allow_pm=True)
async def quott_(event):
    ...
    message = await reply.reply("Quotly by MHMuser", file=file)
    os.remove(file)
    await msg.delete()
    return message
