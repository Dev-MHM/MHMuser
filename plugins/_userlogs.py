...
from pyMHMuser.dB.botchat_db import tag_add, who_tag
...
if udB.get_key("TAG_LOG"):
    ...
    @MHMup_bot.on(events.MessageEdited(func=lambda x: not x.out))
    ...
    async def idk(e):
        ...
        if chat and msg:
            try:
                await MHMup_bot.send_message(chat, e.message, reply_to=msg)
...
_client = {"bot": asst, "user": MHMup_bot}
