...
from pyMHMuser.functions.misc import rotate_image
...
async def mi(e):
    ...
    url = await make_html_telegraph("Mediainfo", "MHMuser", f"<code>{murl}</code>")
    ...
    try:
        urll = await make_html_telegraph("Mediainfo", "MHMuser", out)
