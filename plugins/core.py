...
from pyMHMuser.startup.loader import Loader, load_addons

from . import async_searcher, eod, get_string, safeinstall, udB, MHMup_cmd, un_plug


@MHMup_cmd(pattern="install", fullsudo=True)
...
@MHMup_cmd(pattern="pick( (.*)|$)", fullsudo=True)
...
@MHMup_cmd(pattern="getaddons( (.*)|$)", fullsudo=True)
