...
from pyMHMuser.functions.helper import numerize
from pyMHMuser.functions.misc import create_instagram_client
...
async def soon_(e):
    ...
    await e.reply(
        ...
        file=photo,
        force_document=True,
        attributes=[DocumentAttributeFilename("InstaMHMuser.jpg")],
    )
    await ew.delete()


@MHMup_cmd(pattern="(instaul|reels|igtv)( (.*)|$)")
