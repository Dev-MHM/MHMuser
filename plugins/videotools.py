...
from pyMHMuser.functions.tools import set_attributes

from . import bash, duration_s, eod, genss, get_string, mediainfo, stdr, MHMup_cmd


@MHMup_cmd(pattern="sample( (.*)|$)")
