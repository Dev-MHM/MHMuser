...
from pyMHMuser.dB.greetings_db import (
    add_goodbye,
    add_thanks,
    add_welcome,
    delete_goodbye,
...
from . import HNDLR, eor, get_string, mediainfo, MHMup_cmd
from ._inline import something

Note = "\n\nNote: `{mention}`, `{group}`, `{count}`, `{name}`, `{fullname}`, `{username}`, `{userid}` can be used as formatting parameters.\n\n"


@MHMup_cmd(pattern="setwelcome", groups_only=True)
...
@MHMup_cmd(pattern="clearwelcome$", groups_only=True)
...
@MHMup_cmd(pattern="getwelcome$", groups_only=True)
...
@MHMup_cmd(pattern="setgoodbye", groups_only=True)
...
@MHMup_cmd(pattern="cleargoodbye$", groups_only=True)
...
@MHMup_cmd(pattern="getgoodbye$", groups_only=True)
...
@MHMup_cmd(pattern="thankmembers (on|off)", groups_only=True)
