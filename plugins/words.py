...
from pyMHMuser.functions.misc import get_synonyms_or_antonyms
from pyMHMuser.functions.tools import async_searcher

from . import get_string, MHMup_cmd


@MHMup_cmd(pattern="meaning( (.*)|$)", manager=True)
