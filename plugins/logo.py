...
from pyMHMuser.functions.misc import unsplashsearch
from pyMHMuser.functions.tools import LogoHelper
from telethon.tl.types import InputMessagesFilterPhotos

from . import OWNER_ID, OWNER_NAME, download_file, get_string, mediainfo, MHMup_cmd


@MHMup_cmd(pattern="logo( (.*)|$)")
    ...
    if not bg_:
        if event.client._bot:
            ...
            async for i in event.client.iter_messages(
                "@MHMuserLogos", filter=InputMessagesFilterPhotos
            ):
                pics.append(i)
