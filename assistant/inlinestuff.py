...
from pyMHMuser.functions.misc import google_search
...
ultpic = "https://telegra.ph/file/6a24e2541c3cf2325a939.jpg"
...
async def repo(e):
    res = [
        await e.builder.article(
            ...
            text="• **MHMuser USERBOT** •",
            buttons=SUP_BUTTONS,
        ),
    ]
    await e.answer(res, switch_pm="MHMuser Repo.", switch_pm_param="start")
...
async def piston_run(event):
    try:
        ...
        result = await event.builder.article(
            ...
            thumb=wb(
                "https://telegra.ph/file/b5d1429dd41439cf43b8a.jpg", 0, "image/jpeg", []
            ),
            text=f'**Inline Usage**\n\n`@{asst.me.username} run python print("hello world")`\n\n[Language List](https://telegra.ph/MHMuser-09-01-6)',
        )
    ...
    try:
        ...
        return await ult.answer(
            [
                await ult.builder.article(
                    title="How to Use?",
                    description="Tl Searcher by MHMuser",
