...
COPYRIGHT = f"©️ MHMuser {datetime.now().year}"
...
3. Some of the plugins are disabled for 'Termux Users' to save resources (by adding in EXCLUDE_OFFICIAL).
   - Read More - https://t.me/MHMuser/36
...
█▄▄▄▄▄▄▄█▄▄▄▄▄▄▄█ █▄▄▄█ █▄▄▄█  █▄█▄▄▄▄▄▄▄█▄▄▄█▄▄▄▄▄▄█ 
{Style.RESET_ALL}
{Fore.GREEN}- MHMuser Termux Installation -
  The Main Aim of this script is to deploy MHMuser with basic requirements and save your phone resources.
{Fore.RESET}
...
print(f"{Fore.YELLOW}* Do you want to get MHMuser Logs in Colors? [Y/N] ")
...
sleep(0.2)
print(f"Use 'bash startup' to try running MHMuser.{Fore.RESET}")
sleep(0.5)
print("\nYou can head over to @MHMuser, if you get stuck somewhere, and need help.")
sleep(0.5)
print("\nMade with ❤️ by @MHMuser...")
