...
def start():
    ...
    print(f"{a}\n\n")
    print("Welcome to MHMuser, lets start setting up!\n\n")
    print("Cloning the repository...\n\n")
    os.system("rm -rf MHMuser")
    os.system("git clone https://github.com/Dev-MHM/MHMuser")
    print("\n\nDone")
    os.chdir("MHMuser")
    clear_screen()
    print(a)
    ...
    all_done = "# MHMuser Environment Variables.\n# Do not delete this file.\n\n"
    for i in varrs:
        all_done += do_input(i)
    clear_screen()
    print(a)
    ...
    if isitdone == "y" or isitdone != "n":
        # https://github.com/Dev-MHM/MHMuser/blob/31b9eb1f4f8059e0ae66adb74cb6e8174df12eac/resources/startup/locals.py#L35
        f = open(".env", "w")
        f.write(all_done)
    else:
...
def gen_session():
    print("\nProcessing...")
    # https://github.com/Dev-MHM/MHMuser/main/resources/startup/locals.py#L35
