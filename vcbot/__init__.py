...
from pyMHMuser import HNDLR, LOGS, asst, udB, vcClient
from pyMHMuser._misc._decorators import compile_pattern
...
from pyMHMuser.functions.admins import admin_check
from pyMHMuser.functions.tools import is_url_ok
from pyMHMuser.functions.ytdl import get_videos_link
from pyMHMuser._misc import owner_and_sudos, sudoers
from pyMHMuser._misc._assistant import in_pattern
        ...
        try:
            await vcClient(
                functions.phone.CreateGroupCallRequest(
                    self._chat, title="🎧 MHMuser Music 🎶"
                )
            )
